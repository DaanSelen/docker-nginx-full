...
DOCKER_IMAGE="${REGISTRY:-docker.io}/${REPOSITORY:-nginxproxymanager}/nginx-full"

export OPENRESTY_VERSION=1.29.2.3
export CROWDSEC_OPENRESTY_BOUNCER_VERSION=1.7.7
